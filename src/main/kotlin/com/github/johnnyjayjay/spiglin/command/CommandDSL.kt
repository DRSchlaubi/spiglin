 ...
 */
public fun JavaPlugin.command(name: String, convention: CommandConvention.() -> Unit) {
 ...
 */
public fun command(command: CommandConvention.() -> Unit): CommandExecutor = CommandConvention().apply(command).build()

/**
 * Convention used in Command DSL.
 */
public class CommandConvention internal constructor() {
     ...
     */
    public fun subCommand(name: String, command: CommandConvention.() -> Unit) {
