...
dependencies {
    ...
    // Tests
    testImplementation("org.spigotmc:spigot-api:1.14.4-R0.1-SNAPSHOT") // Tests do not have spigot classes in classpath since they're not being executed within a spigot server
